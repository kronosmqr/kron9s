...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: 'Relaxa ai @${num.split('@')[0]} sua figurinha já esta saindo do forno! 😂😂',
				success: '✔️ Deu certo, ufa KKKKK ✔️',
				error: {
				...
				only: {
					...
					ownerG: '⚠️ Este comando só pode ser usado pelo dono do grupo 😂🖕🏿',
					ownerB: '❌ Este comando só pode ser usado pelo proprietário do bot! ❌',
					admin: '⚠️ Este comando só pode ser usado por admins!🖕🏿😐',
					Badmin: '❌ Este comando só pode ser usado quando o bot se torna um administrador! falando nisso, da adm ai mano? akskksksk🖕🏿😂'
				}
			}
